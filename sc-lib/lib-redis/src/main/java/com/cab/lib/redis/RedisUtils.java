...
//import com.martin.micro.common.config.key.EhcacheConfig;
//import com.martin.micro.common.config.key.EhcacheKeyEnum;
//import com.martin.micro.common.config.key.RedisKeyEnum;
...
//    }
//
//    public <T> void setObj(RedisKeyEnum.RedisKey key, T value) throws Exception {
...
//    }
//
//    public <T extends Serializable> T getObj(RedisKeyEnum.RedisKey key) throws Exception {
//        final String keyStr = key.get();
//        return redisTemplate.execute(new RedisCallback<T>() {
//            public T doInRedis(RedisConnection connection) throws DataAccessException {
//                byte[] keyBytes = keyStr.getBytes();
...
//    public void set(RedisKeyEnum.RedisKey key, V value) throws Exception {
...
//
//    //RedisKeyEnum.USER_INFO.get( 3333)
//    public V get(RedisKeyEnum.RedisKey key) throws Exception {
//        BoundValueOperations<K, V> valueOper = redisTemplate.boundValueOps((K) key.get());
//        return valueOper.get();
//    }
//
...
//
//    //RedisKeyEnum.USER_INFO.get( 3333)
//    public void rm(RedisKeyEnum.RedisKey key) throws Exception {
...
//
//    //RedisKeyEnum.USER_INFO.get( 3333)
//    public void _rms(RedisKeyEnum.RedisKey key) throws Exception {
...
//    }
//
//    public Long decrGetLong(RedisKeyEnum.RedisKey key,Long step) throws Exception{
//        final String keyStr = key.get();
//        return redisTemplate.execute(new RedisCallback<Long>() {
//            public Long doInRedis(RedisConnection connection) throws DataAccessException {
//                byte[] keyBytes = keyStr.getBytes();
...
//
//	@Override
//	public <T extends Serializable> void setList(RedisKeyEnum.RedisKey key, List<T> list) throws Exception {
//		ListObj listObj = new ListObj(list);
//        setObj(key,listObj);
//	}
//
//	@Override
//	public <T extends Serializable> List<T> getList(RedisKeyEnum.RedisKey key, Class<T> cls) throws Exception {
//		ListObj listObj = getObj(key);
//        if (null != listObj && listObj instanceof ListObj){
//            return listObj.getList();
//        }
